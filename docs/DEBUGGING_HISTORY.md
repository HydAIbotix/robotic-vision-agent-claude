# Debugging & Change History — robotic-vision-agent-claude

> Archived from CLAUDE.md (2026-08-19) to keep the main guide under size. This is the full
> chronological log of debugging sessions and fixes (2026-06-25 → 2026-08-18). Nearly every
> entry is **✅ fixed**; it is kept as a searchable archive of *how* each issue was found and
> resolved. The still-relevant invariants distilled from this log live in CLAUDE.md under
> "Invariants, gotchas & open items". Read this file when you need the full story behind a
> specific fix; trust CLAUDE.md and the code for current behaviour.

---

## Work done in the earlier session (reconstructed from git, commits `73cc052`…`6079702`, 2026-07-03 → 07-07)
